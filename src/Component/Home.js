...
class Home extends Component {
    render() {
        return (
            ...
            it is positioned on number #5. But, I will definitely let you believe, here’s why?
            Python is one of the general purpose, user-friendly programming language here on my 
            list. What makes it so? Like Java, Python syntax is clear, intuitive and almost similar to 
            ...
            have migrated to python are close to 42%, which signifies it to be at number.</p>    
            </div>
        );
    }
}
